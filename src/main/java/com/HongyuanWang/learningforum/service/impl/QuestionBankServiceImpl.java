...
import com.HongyuanWang.learningforum.model.dto.questionBank.QuestionBankQueryRequest;
import com.HongyuanWang.learningforum.model.entity.QuestionBank;
import com.HongyuanWang.learningforum.model.entity.QuestionBankFavour;
import com.HongyuanWang.learningforum.model.entity.QuestionBankThumb;
...
public class QuestionBankServiceImpl extends ServiceImpl<QuestionBankMapper, QuestionBank> implements QuestionBankService {
    ...
    public QueryWrapper<QuestionBank> getQueryWrapper(QuestionBankQueryRequest questionBankQueryRequest) {
        ...
        String descriotion = questionBankQueryRequest.getDescription();
        ...
        queryWrapper.like(StringUtils.isNotBlank(descriotion), "description", descriotion);
